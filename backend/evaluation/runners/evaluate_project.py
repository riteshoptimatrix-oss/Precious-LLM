...
from app.knowledge.models import ProjectRecord
    ...
    async def run(self) -> Dict[str, Any]:
        ...
        for test in test_cases:
            ...
            if cat == "dynamic_update":
                ...
                passed = "Completed" in resp_text and "In Progress" not in resp_text
                results.append({
                    "id": test_id,
                    "category": cat,
                ...
                passed = all(k in proj_ctx for k in ["P001", "ABC", "test_projects"]) if proj_ctx else False
                results.append({
                    "id": test_id,
                    "category": cat,
                    "prompt": prompt,
                ...
                has_forbidden = any(s.lower() in resp_text.lower() for s in forbidden_statuses)
